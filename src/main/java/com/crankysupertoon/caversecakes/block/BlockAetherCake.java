...
public class BlockAetherCake extends BlockCakeBase implements ITileEntityProvider {
    public ModConfig.DimensionConfig config = ModConfig.aether;
    public String cakeName = "aether";

    public BlockAetherCake() {
        super();
