package com.crankysupertoon.caversecakes.block;
...
public class BlockUnderworldCake extends BlockCakeBase implements ITileEntityProvider {
    public ModConfig.DimensionConfig config = ModConfig.underworld;
    public String cakeName = "underworld";

    public BlockUnderworldCake() {
        super();
        setRegistryName(CaverseCakes.MODID + ":" + cakeName + "_cake");
        setTranslationKey(CaverseCakes.MODID + "." + cakeName + "_cake");
    }
