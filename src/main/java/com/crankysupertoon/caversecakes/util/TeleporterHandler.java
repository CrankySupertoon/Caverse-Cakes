package com.crankysupertoon.caversecakes.util;
...
public class TeleporterHandler {
    ...
    public static NBTTagCompound getModNBTData(EntityPlayer player) {
        NBTTagCompound dimensionCache = (NBTTagCompound) player.getEntityData().getTag(CaverseCakes.MODID);
        if (dimensionCache == null) {
            dimensionCache = new NBTTagCompound();
            player.getEntityData().setTag(CaverseCakes.MODID, dimensionCache);
        }
