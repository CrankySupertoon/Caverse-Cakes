...
//Recipes for the Cakes //
        ...
        if (ModConfig.overworld.enableCake)
            GameRegistry.addShapedRecipe(ModBlocks.underworldCake.getRegistryName(), null, new ItemStack(ModBlocks.underworldCake),
                    "SSS", "SCS", "SSS", 'S', "stone", 'C', Items.CAKE);
        ...
        if (ModConfig.overworld.enableCake && DimensionManager.isDimensionRegistered(ModConfig.overworld.dimID))
...
// Recipes for the Apples //
        ...
        if (ModConfig.overworld.enableApple && DimensionManager.isDimensionRegistered(ModConfig.overworld.dimID))
            GameRegistry.addShapedRecipe(ModItems.underworldApple.getRegistryName(), null, new ItemStack(ModItems.underworldApple),
                    "III", "IAI", "III", 'I', "stone", 'A', new ItemStack(Items.GOLDEN_APPLE, 1, 0));
