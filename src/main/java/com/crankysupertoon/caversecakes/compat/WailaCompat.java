...
import com.crankysupertoon.caversecakes.block.BlockCakeBase;
import com.crankysupertoon.caversecakes.block.tile.TileDimensionCake;
import com.crankysupertoon.caversecakes.util.IWailaInfoProvider;
...
public class WailaCompat implements IWailaDataProvider {
    ...
    public static void register() {
        if (registered)
            return;
        registered = true;
        FMLInterModComms.sendMessage("waila", "register", "com.crankysupertoon.caversecakes.compat.WailaCompat.load");
    }
